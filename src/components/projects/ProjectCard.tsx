...
const ProjectCard = (props: PropjectInterface) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`border p-5 rounded-lg shadow-lg w-[330px] flex flex-col gap-5 ${isVisible ? "animate-fadeslideup-5" : "opacity-0"} opacity-0 dark:text-white`}
    >
      <div
      ...
      <div className="flex justify-between items-center">
        ...
        <a
          ...
          className="self-end rounded-md bg-primary dark:bg-white text-white dark:text-black px-3 py-1 hover:shadow-md"
        >
          visit
        </a>
      </div>
