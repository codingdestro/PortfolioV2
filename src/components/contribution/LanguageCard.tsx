...
const LanguagesCard = () => {
  ...
  return (
    <div
      ref={divRef}
      className={`flex flex-col gap-2 opacity-0 ${isVisible && "animate-fadeslideup-5"} dark:text-white`}
    >
      <h3 className="font-poppins font-semibold capitalize text-sm md:text-md">
        most used tech
      </h3>
      <div className="border border-black dark:border-white rounded-md p-5 text-sm">
